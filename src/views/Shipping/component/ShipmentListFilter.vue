      ...
      <div class="dropdown relative inline-flex w-full">
        ...
        >
          ...
          <li v-for="st in statuses" :key="st.value">
            <a class="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer rounded-lg" @click="selectOption('status', st.value)">
              {{ st.label }}
            </a>
          </li>
        </ul>
...
// Fixed set of shipment statuses (adjust to match backend values)
const statuses = ref([
