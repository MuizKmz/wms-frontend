            ...
            <div class="p-6 space-y-4">
              ...
              <div class="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <p class="font-medium text-gray-900 dark:text-white">{{ receiving.warehouseName || receiving.warehouseId || '-' }}</p>
                </div>
                <div>
              ...
              <div>
                <p class="text-xs text-gray-500">Source / Purpose</p>
                <p class="font-medium text-gray-900 dark:text-white">{{ receiving.source || '-' }} / {{ receiving.purpose || '-' }}</p>
              </div>
