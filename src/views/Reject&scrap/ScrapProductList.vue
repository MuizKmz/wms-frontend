<template>
  <AdminLayout>
    ...
    <div class="space-y-5 sm:space-y-6">
      <ComponentCard title="All Scrap Product List" desc="Overview of all Scrap Product List">
        ...
        <!-- Table in main slot -->
        <ScrapListTable :filters="activeFilters" />
      </ComponentCard>
    </div>
  </AdminLayout>
</template>
...
import ScrapListTable from "./component/ScrapListTable.vue";
