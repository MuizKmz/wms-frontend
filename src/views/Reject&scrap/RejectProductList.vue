<template>
  <AdminLayout>
    ...
    <PageTitle title="Reject & Scrap Management"/>
    <ToolListFilters @filter-change="handleFilterChange" />
    
    <div class="space-y-5 sm:space-y-6">
      <ComponentCard title="All Reject Product List" desc="Overview of all Reject Product List">
        ...
        <!-- Table in main slot -->
        <RejectListTable :filters="activeFilters" />
      </ComponentCard>
    </div>
  </AdminLayout>
</template>
...
import RejectListTable from "./component/RejectListTable.vue";

const currentPageTitle = ref("Reject & Scrap Management");
