  ...
  <div class="overflow-hidden">
    ...
    <div class="mb-4">
      <p class="text-sm text-gray-500 dark:text-gray-400">
        Showing {{ filteredData.length }} reject product items
      </p>
    </div>
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
      ...
      <div v-if="loading" class="p-8 text-center text-gray-500 text-sm">
        ...
        <p>Loading reject product items...</p>
      </div>
      ...
      <div v-if="!loading && filteredData.length === 0" class="p-8 text-center text-gray-500">
        ...
        <p class="mt-2 text-sm font-medium text-gray-900 dark:text-white">
          No reject product items found
        </p>
        <p class="text-sm text-gray-500 dark:text-gray-400">
          Try adjusting your filters or create a new reject product item.
        </p>
      </div>
      ...
      <div v-if="error" class="p-8 text-center text-red-500 text-sm">
        ...
        <p class="font-medium">Error loading reject product items</p>
...
// Mock data for reject product items based on the image
const mockData = [
  {
    rejectId: "RJT-0001",
    date: "2025-06-15",
    ...
    rejectReason: "Flashing on edges",
    quantity: "25 pcs",
    status: "Rejected"
  },
  {
    ...
    rejectReason: "Length out of spec",
    quantity: "40 pcs",
    status: "Under Review"
  },
  {
    ...
    inspector: "Wong Jin",
    rejectReason: "Contamination (black dot)",
    quantity: "15 pcs",
    status: "Rejected"
  },
  {
  ...
  },
  {
    ...
    rejectReason: "Poor surface finish",
    quantity: "18 pcs",
    status: "Rejected"
  },
  {
    ...
    machineName: "Trimming Unit 05",
    inspector: "Nurul Amirah",
    rejectReason: "Off-color",
    quantity: "30 pcs",
    status: "Rejected"
  },
  {
    rejectId: "RJT-0007",
    date: "2025-06-18",
    jobOrderId: "JO-240607",
    productCodeName: "PRD-1007 / Seal G",
    machineName: "Feeder System 01",
    inspector: "Ahmad Zaki",
    rejectReason: "Incomplete product",
    quantity: "22 pcs",
    status: "Under Review"
  }
]
...
const fetchData = async (filters = {}) => {
  ...
  try {
    ...
    const res = await fetch("/api/reject-product-items")
    if (!res.ok) throw new Error("Failed to fetch reject product items")
...
const filteredData = computed(() => {
  ...
  return data.value.filter((item) => {
    ...
    if (
      ...
      !item.rejectId
        .toLowerCase()
        .includes(filters.rejectId.toLowerCase())
    ) {
      return false
    }
    if (
