  ...
  <div class="overflow-hidden">
    ...
    <div class="mb-4">
      <p class="text-sm text-gray-500 dark:text-gray-400">
        Showing {{ filteredData.length }} IPQC inspection items
      </p>
    </div>
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
      <table class="min-w-full">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tr v-for="(item, index) in paginatedData" :key="index"
            ...
            <!-- Result -->
            <td class="px-6 py-4">
              <span :class="getResultStatusClass(item.result)"
      ...
      <div v-if="loading" class="p-8 text-center text-gray-500 text-sm">
        ...
        <p>Loading IPQC inspection items...</p>
      </div>
      ...
      <div v-if="!loading && filteredData.length === 0" class="p-8 text-center text-gray-500">
        ...
        <p class="mt-2 text-sm font-medium text-gray-900 dark:text-white">
          No IPQC inspection items found
        </p>
        <p class="text-sm text-gray-500 dark:text-gray-400">
          Try adjusting your filters or create a new IPQC inspection item.
        </p>
      </div>
      ...
      <div v-if="error" class="p-8 text-center text-red-500 text-sm">
        ...
        <p class="font-medium">Error loading IPQC inspection items</p>
...
// Mock data for QC inspection items based on the image
const mockData = [
  {
    ipqcId: "QC-0001",
    date: "2025-06-15",
  ...
  },
  {
    ...
    qcType: "Dimension Check",
    inspector: "Tan Mei Ling",
    result: "Fail",
    remarks: "Length out of tolerance"
  },
  {
    ipqcId: "QC-0003",
    date: "2025-06-16",
    ...
    qcType: "Material Mixing",
    inspector: "Siti Aisyah",
    result: "Pass",
    remarks: "Uniform compound"
  },
  {
    ipqcId: "QC-0004",
    date: "2025-06-16",
  ...
  },
  {
    ...
    qcType: "Functional Check",
    inspector: "Karthik Rao",
    result: "Fail",
    remarks: "Motor intermittently stops"
  },
  {
    ipqcId: "QC-0006",
    date: "2025-06-17",
...
const fetchData = async (filters = {}) => {
  ...
  try {
    ...
    const res = await fetch("/api/qc-inspection-items")
    if (!res.ok) throw new Error("Failed to fetch QC inspection items")
...
const filteredData = computed(() => {
  ...
  return data.value.filter((item) => {
    ...
    if (
      ...
      !item.ipqcId
        .toLowerCase()
        .includes(filters.ipqcId.toLowerCase())
    ) {
      return false
    }
    if (
